...
const SignInUp = () => {
    ...
    const validateSignUp = () => {
        ...
        if (filter.isProfane(formData.email))
            newFormErrors = { ...newFormErrors, email: "Email is invalid." };
    ...
    const validateConfirmSignUp = () => {
        ...
        if (filter.isProfane(formData.firstname))
            newFormErrors = { ...newFormErrors, firstname: "Invalid firstname." };
        if (formData.lastname.length === 0) newFormErrors = { ...newFormErrors, lastname: "Lastname cannot be empty." };
        if (filter.isProfane(formData.lastname))
            newFormErrors = { ...newFormErrors, lastname: "Invalid lastname." };
        if (formData.major.length === 0) newFormErrors = { ...newFormErrors, major: "Major cannot be empty." };
        if (filter.isProfane(formData.major))
            newFormErrors = { ...newFormErrors, major: "Invalid major." };
