...
const Settings = () => {
    ...
    const validateUpdate = () => {
        ...
        if (filter.isProfane(formData.firstname.trim())) newFormErrors.firstname = "Invalid firstname";
        if (filter.isProfane(formData.lastname.trim())) newFormErrors.lastname = "Invalid lastname.";
        if (filter.isProfane(formData.major.trim())) newFormErrors.major = "Invalid major.";
